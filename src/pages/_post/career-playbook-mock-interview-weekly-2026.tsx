...
export default function CareerPlaybookMockInterviewWeekly2026() {
  return <><p>模擬面接は回数だけ増やしても効果が出ません。改善対象を絞る設計が必要です。</p><h2>結論</h2><p>週2回（本番想定1回＋改善確認1回）が最もバランスが良いです。</p><h2>改善の型</h2><ul><li>回答時間の最適化</li><li>結論先出し</li><li>逆質問の質</li></ul><h2>まとめ</h2><p>録音と要点メモを残すだけで通過率は上がります。</p></>;
}
