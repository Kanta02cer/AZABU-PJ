...
export default function CareerPlaybookLearningTimeManagementWorker2026() {
  return <><p>時間がない人ほど、学習量より習慣化が重要です。</p><h2>結論</h2><p>平日30分＋休日2時間の固定化で十分に進められます。</p><h2>実践</h2><ul><li>朝学習の固定</li><li>通勤時間の復習</li><li>週次レビュー</li></ul><h2>まとめ</h2><p>完璧主義を捨て、継続可能な型を先に作りましょう。</p></>;
}
